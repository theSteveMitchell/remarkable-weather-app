const MOCK_COLUMBUS_CONDITIONS = [{
...
const mocks = {
  MOCK_COLUMBUS_CONDITIONS,
  MOCK_BEVERLY_CONDITIONS,
  MOCK_HONOLULU_CONDITIONS,
  MOCK_DENVER_CONDITIONS
}
